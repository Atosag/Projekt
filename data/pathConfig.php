<?php
	...
	defined('ProjectRootPath') ? null : define('ProjectRootPath',  '/storage/content/84/198884/atosag.nu/public_html/MagnussonsGalleri');
	// Define helper path.								
	...
	require_once(HelperPath.DS.'styles.css');
